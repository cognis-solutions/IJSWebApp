...
public class IjsContractSearchJdbcDao extends IjsBaseDao implements IjsContractSearchDao {
    ...
    public void initDao() throws Exception {
        ...
        getIjsSearchStoredProcedure = 
                new GetIjsSearchStoredProcedure(getJdbcTemplate(), 
                                                new IjsContractSearchRowMapper());
        //##01 END
        ijsContractSaveStoredProcedure = 
                new IjsContractSaveStoredProcedure(getJdbcTemplate()); //##03
        //##04 BEGIN
        ijsContractDeleteStoredProcedure = 
                new IjsContractDeleteStoredProcedure(getJdbcTemplate());
        ijsContractSuspendStoredProcedure = 
                new IjsContractSuspendStoredProcedure(getJdbcTemplate());
        ijsContractCompareStoredProcedure = 
                new IjsContractCompareStoredProcedure(getJdbcTemplate(), 
                                                      new IjsContractSearchRowMapper());
        ijsContractHistoryStoredProcedure = 
                new IjsContractHistoryStoredProcedure(getJdbcTemplate(), 
                                                      new IjsContractHistoryRowMapper());
        ijsCntrVendorDetailsStrdProce = 
                new IjsCntrVendorDetailsStrdProce(getJdbcTemplate(), 
                                                  new IjsCntrVendorDetailsRowMapper());
        contractRateDao = new IjsContractRateJdbcDao();
        //##04 END

        getIjsContractDownloadStoredProcedure = 
                new GetIjsContractDownloadStoredProcedure(getJdbcTemplate(), 
                                                          new IjsCostContractDownloadRowMapper(), 
                                                          new IjsBillContractDownloadRowMapper());

        getIjstermListStoredProcedure = 
                new GetIjstermListStoredProcedure(getJdbcTemplate(), 
                                                  new IjsTermListRowMapper());
                                                  
        ijsCostRateStoredProcedure =  new IjsCostRateStoredProcedure(getJdbcTemplate(), 
                                                  new IjsCostRateRowMapper());  
        ijsBillingRateStoredProcedure=new IjsBillingRateStoredProcedure(getJdbcTemplate(), 
        										  new IjsBillingRateRowMapper());
                                                  
        getIjsTransportModeListStoredProcedure = 
                new GetIjsTransportModeListStoredProcedure(getJdbcTemplate(), 
        ...
        //        ijsCntrCurrencyForUserProcedure  = new IjsCntrCurrencyForUserProcedure(getJdbcTemplate()
        ...
        ijsContractForSameVendorValidationProcedure=new IjsContractForSameVendorValidationProcedure(getJdbcTemplate());
    ...
    public List<IjsContractShipmentTermVO> getTermList(String userId) throws IJSException {
        ...
        List<IjsContractShipmentTermVO> lstTerrmList = 
            getIjstermListStoredProcedure.getTermList(userId);
        return lstTerrmList;
    }
    
    public List<IjsContractTransportModeVO> getTransportMode(String userId, String vendorCode) throws IJSException {

        List<IjsContractTransportModeVO> lstTransportModeList = 
            getIjsTransportModeListStoredProcedure.getTransportMode(userId, vendorCode);
    ...
    public List<IjsCntrCurrencyLookUpVO> getCurrencyForFSC(String userId, String paymentFscCode) throws IJSException {
        List<IjsCntrCurrencyLookUpVO> listCurrencyForFSC = 
        ijsCntrCurrencyForContractProcedure.getCurrencyForContract(userId,paymentFscCode);
        return listCurrencyForFSC;
    }
    
    public IjsCntrCurrencyLookUpVO getCurrencyForLocation(String userId, String location, String locationType) throws IJSException {
    ...
    public String getTerminalCode(String userId, String location, String locationType, String terminal) throws IJSException {
...
//        }
    ...
    //            list = ijsCntrCurrencyForUserProcedure.getCurrencyForUser(ijsLookupParamVO.getFindIn()
    //                , ijsLookupParamVO.getFindFor(), ijsLookupParamVO.getWildCard(),userInfo);
    //            }
     ...
     * @throws IJSException
     */
    public List<IjsContractSearchDTO> findContracts(String transMode, 
                                                    String dateRange, 
                                                    String userId, 
                                                    IjsContractSearchParamVO searchParam) throws IJSException {
        List<IjsContractSearchDTO> lstContractSearch = 
            getIjsSearchStoredProcedure.getIjsContractSearchList(transMode, 
                                                                 dateRange, 
                                                                 userId, 
                                                                 searchParam);
        if (lstContractSearch == null || lstContractSearch.isEmpty()) {
            IJSException ijsException = 
                new IJSException(IjsErrorCode.DB_IJS_COMM_EX_10001.getErrorCode());
            throw ijsException;
        }
    ...
    public Map findContractsToDownload(String transMode, String dateRange, 
                                       ...
                                       List<IjsContractDownloadDTO> lstCostContractSearch, 
                                       List<IjsContractDownloadDTO> lstBillContractSearch, 
                                       String sessionId) throws IJSException {
        Map lstContractSearch = 
            getIjsContractDownloadStoredProcedure.getIjsContractDownloadList(transMode, 
                                                                             dateRange, 
                                                                             userId, 
                                                                             searchParam, 
                                                                             lstCostContractSearch, 
                                                                             lstBillContractSearch, 
                                                                             sessionId);
        if (lstContractSearch == null || lstContractSearch.isEmpty()) {
            IJSException ijsException = 
                new IJSException(IjsErrorCode.DB_IJS_COMM_EX_10001.getErrorCode());
...
//        ArrayList<IjsContractMessageVO> lstErrorMsg = new ArrayList<IjsContractMessageVO>();
        for (IjsLocationVO ijsLocationVO : lstLocation){
        	String errorCode =ijsContractUserValidationProcedure.validateUserToCreateContract(userInfo, ijsLocationVO.getFromLocation(), 
            		ijsLocationVO.getToLocation(), ijsContractVO.getVendorCode());
     ...
     //Validate Vendor
      //if(IjsActionMethod.NEW.getAction().equals(action)){
         ...
         //Validate existance of contract for same Vendor 
             for (IjsLocationVO ijsLocationVO : lstLocation){
                 outMap = ijsContractForSameVendorValidationProcedure.validateContractForSameVendor(ijsContractVO, ijsLocationVO);
                 String errorCode = (String)outMap.get("p_o_v_err_cd");
     ...
     //Validate Priority overlapped 
         for (IjsLocationVO ijsLocationVO : lstLocation){
        	 /*Changes to fix priority issue,If priority is zero ,it means user haven't input a priority
        	 get max priority */
        	 if(ijsLocationVO.getPriority()==0){
        		 ...
        		 outMap = ijsContractPriorityValidationProcedure.validateContractPriorty(ijsContractVO, ijsLocationVO); 
        	 }
     ...
     if (IjsActionMethod.NEW.getAction().equals(action) || IjsActionMethod.NEW_CHANGE_PRIORITY.getAction().equals(action)
     ...
     IjsActionMethod.COPY.getAction().equals(action)){
        ...
        for (IjsLocationVO ijsLocationVO : lstLocation){
             ...
             outMap = ijsContractSaveStoredProcedure.saveORUpdateContracts(ijsContractVO, ijsLocationVO, userInfo, action);
             String errorCode = (String)outMap.get("p_o_v_err_cd");
...
//             } 
        ...
        else if(IjsActionMethod.EDIT.getAction().equals(action)||IjsActionMethod.EDIT_CHANGE_PRIORITY.getAction().equals(action)){
        	 for (IjsLocationVO ijsLocationVO : lstLocation){
            	 /*Changes to fix priority issue,If priority is zero ,it means user haven't input a priority
            	 get max priority */
            	 if(ijsLocationVO.getPriority()==0){
        ...
        outMap = ijsContractSaveStoredProcedure.saveORUpdateContracts(ijsContractVO, ijsContractVO.getLocations().get(0), userInfo, action);
        String errorCode = (String)outMap.get("p_o_v_err_cd");
        if (errorCode != null && errorCode.contains("DB_IJS_CNTR_EX_10006")) {
            ...
            throw new IJSException(IjsErrorCode.DB_IJS_CNTR_EX_10008.getErrorCode());
                ...
                errorCode.contains("DB_IJS_CNTR_JO_EX_1001")) {
         throw new IJSException(IjsErrorCode.DB_IJS_CNTR_JO_EX_1001.getErrorCode());
     } else if (errorCode != null && 
             errorCode.contains("DB_IJS_RATE_EX_10023")) {
      throw new IJSException(IjsErrorCode.DB_IJS_RATE_EX_10023.getErrorCode());
  }
        else {
   ...
   return null;
     ...
     * @throws IJSException
     */
    public String deleteContract(List<String> contractsList, 
        ...
        for (String contractId: contractsList) {
            errorCode = 
                    ijsContractDeleteStoredProcedure.deleteContract(contractId, 
                                                                    userInfo);
            if (errorCode != null && 
                    errorCode.contains("DB_IJS_CNTR_JO_EX_1002")) {
                	failedContracts.append(contractId).append(",");
                    /*response.put(contractId, 
                                 IjsErrorCode.DB_IJS_CNTR_EX_10010.getErrorCode());*/
                } 
            }
     ...
     * @throws IJSException
     */
    public String suspendContract(List<String> contractsList, 
                                               String userInfo) throws IJSException {
        String errorCode = null;
        StringBuilder failedContracts=new StringBuilder();
        for (String contractId: contractsList) {
            errorCode = 
                    ijsContractSuspendStoredProcedure.suspendContract(contractId, 
                                                                      userInfo);
            if (errorCode != null && 
                errorCode.contains("DB_IJS_CNTR_JO_EX_1001")) {
            	failedContracts.append(contractId).append(",");
    ...
    public List<IjsContractSearchDTO> compareContract(IjsContractVO ijsContractVO, 
        ...
        // TO-DO
        List<IjsContractSearchDTO> contractList = 
            ijsContractCompareStoredProcedure.getContractList(ijsContractVO, 
                                                              userInfo);
        if (contractList == null || contractList.isEmpty()) {
            ...
            for (IjsContractSearchDTO ijsContractSearchDTO : contractList) {
                 List<IjsContractCostDTO> outList = ijsCostRateStoredProcedure.getCostRate(ijsContractSearchDTO.getRoutingId(), userInfo);
                 List<IjsContractCostDTO> rateFilteredList=null;
                 List<IjsContractBillingDTO> billingList = ijsBillingRateStoredProcedure.getBillingRate(ijsContractSearchDTO.getRoutingId(), userInfo);
                 ...
                 for(IjsContractCostDTO ijsContractCostDTO: outList){
	      			 ...
	      			 if((modifiedCurrentDate.before(costExpiryDate) || modifiedCurrentDate.equals(costExpiryDate))
							   &&(modifiedCurrentDate.after(costEffectiveDate) || modifiedCurrentDate.equals(costEffectiveDate))){
	      			 ...
	      			 }else if(modifiedCurrentDate.after(costExpiryDate) && modifiedCurrentDate.after(costEffectiveDate)){
	      				switch(ijsContractCostDTO.getMtLaden()){
	      				  case "LADEN":{
                ...
                for(IjsContractBillingDTO ijsContractBillingDTO: billingList){
     			  ...
     			  if((modifiedCurrentDate.before(billingExpiryDate) || modifiedCurrentDate.equals(billingExpiryDate))
						   &&(modifiedCurrentDate.after(billingEffectiveDate) || modifiedCurrentDate.equals(billingEffectiveDate))){
                ...
                }else if(modifiedCurrentDate.after(billingExpiryDate) && modifiedCurrentDate.after(billingEffectiveDate)){
      				switch(ijsContractBillingDTO.getMtLaden()){
    				  case "LADEN":{
            ...
            if((lstrRateLaden20!=null && !lstrRateLaden20.isEmpty())||
            	...
            	(lstrRateMT45!=null && !lstrRateMT45.isEmpty())){
        		 ijsContractSearchDTO.setRate20((lstrRateLaden20!=null && !lstrRateLaden20.isEmpty() && lstrRateLaden20!="0")?lstrRateLaden20:lstrRateMT20);
                 ijsContractSearchDTO.setRate40((lstrRateLaden40!=null && !lstrRateLaden40.isEmpty()&&lstrRateLaden40!="0")?lstrRateLaden40:lstrRateMT40);
                 ijsContractSearchDTO.setRate45((lstrRateLaden45!=null && !lstrRateLaden45.isEmpty()&& lstrRateLaden45!="0")?lstrRateLaden45:lstrRateMT45);
            	...
            	ijsContractSearchDTO.setRate20((lstrExpiredRateLaden20!=null && !lstrExpiredRateLaden20.isEmpty())?lstrExpiredRateLaden20:lstrExpiredRateMT20);
                ijsContractSearchDTO.setRate40((lstrExpiredRateLaden40!=null && !lstrExpiredRateLaden40.isEmpty())?lstrExpiredRateLaden40:lstrExpiredRateMT40);
                ijsContractSearchDTO.setRate45((lstrExpiredRateLaden45!=null && !lstrExpiredRateLaden45.isEmpty())?lstrExpiredRateLaden45:lstrExpiredRateMT45);
                ijsContractSearchDTO.setCostCurrency(costCurrency);
            }
            ...
            if((billingRateLaden20!=null && !billingRateLaden20.isEmpty())||
            	...
            	ijsContractSearchDTO.setBillingRate20((billingRateLaden20!=null&&!billingRateLaden20.isEmpty())?billingRateLaden20:billingRateMT20);
                ijsContractSearchDTO.setBillingRate40((billingRateLaden40!=null&&!billingRateLaden40.isEmpty())?billingRateLaden40:billingRateMT40);
                ijsContractSearchDTO.setBillingRate45((billingRateLaden45!=null&&!billingRateLaden45.isEmpty())?billingRateLaden45:billingRateMT45);
                ijsContractSearchDTO.setBillingCurrency(billingCurrency);
                	...
                	ijsContractSearchDTO.setBillingRate20((expiredBillingRateLaden20!=null&&!expiredBillingRateLaden20.isEmpty())?expiredBillingRateLaden20:expiredBillingRateMT20);
                    ijsContractSearchDTO.setBillingRate40((expiredBillingRateLaden40!=null&&!expiredBillingRateLaden40.isEmpty())?expiredBillingRateLaden40:expiredBillingRateMT40);
                    ijsContractSearchDTO.setBillingRate45((expiredBillingRateLaden45!=null&&!expiredBillingRateLaden45.isEmpty())?expiredBillingRateLaden45:expiredBillingRateMT45);
                    ijsContractSearchDTO.setBillingCurrency(billingCurrency);
                }
        }
        } 
     ...
     * @throws IJSException
     */
    public List<IjsContractHistory> getContractHistory(String contractId, 
                                                       String userInfo) throws IJSException {
        List<IjsContractHistory> historyList = 
            ijsContractHistoryStoredProcedure.getHistoryList(contractId, 
                                                             userInfo);
    ...
    public IjsContractUploadVO uploadContracts(List<IjsExcelUploadTemplateVO> excelUploadTemplateList, 
        ...
        for (IjsExcelUploadTemplateVO excelUploadTemplate: 
             excelUploadTemplateList) {
            IjsContractVO contractVO = excelUploadTemplate.getIjsContractVO();
            String action = "new";
            if (contractVO.getContractId() != null && 
                contractVO.getContractId().length() > 0) {
                action = "edit";
            }
            if(contractVO.isInvalidContract()){
            	failedContracts.add((contractVO.getContractId()==null || contractVO.getContractId().equals(""))?contractVO.getVendorCode():contractVO.getContractId());
            ...
            if(contractVO.getDays()<0 ||contractVO.getDistance()<0 ||contractVO.getHours()<0 ||contractVO.getPriority()<0){
            ...
            try {
            	isValid1=getTerminalCode(userInfo,contractVO.getFromLocation(),contractVO.getFromLocType(),contractVO.getFromTerminal());
            	isValid2=getTerminalCode(userInfo,contractVO.getToLocation(),contractVO.getToLocType(),contractVO.getToTerminal());
			...
			try {
				IjsCntrCurrencyLookUpVO fscCurrVO=getCurrencyForLocation(userInfo, contractVO.getFromLocation(), contractVO.getFromLocType());
            ...
            try {
            	List<IjsCntrCurrencyLookUpVO> listCurrencyForFSC = getCurrencyForFSC(userInfo, contractVO.getPaymentFsc());
            ...
            try{
            outMap = 
                ijsContractSaveStoredProcedure.saveORUpdateContract(contractVO, 
                                                                    userInfo, 
                                                                    action);
            }catch(Exception e){
            	failedContracts.add((contractVO.getContractId()==null || contractVO.getContractId().equals(""))?contractVO.getVendorCode():contractVO.getContractId());
            ...
            if (errorCode != null) {
                ...
                if (excelUploadTemplate.isIsCostRateUpload()) {
                    ...
                    List<IjsRateVO> rateVOList = 
                        excelUploadTemplate.getIjsCostRateVOList();
                    ...
                    for (IjsRateVO rateVO: rateVOList) {
                        ...
                        try{
                          ...
                          errorCode=ijsCostSetupCheckProcedure.validateCostRateSetup(contractVO.getFromTerminal(),rateVO.getOogCode(),
                        		rateVO.getPortCode(),rateVO.getImdgCode());
                          if(errorCode!=null){
                              break;
                          }
                        try{
                        	costRateResult = 
                                    rateSrv.getIjsContractRateDao().saveOrUpdateCostRate(actionForm, 
                                                                                         userInfo);
                        ...
                        System.out.println("costRateResult --" + 
                                           costRateResult);
                        if (costRateResult != null && 
                            !costRateResult.contains("IJS_MSG")) {
                            continue;
                        }
                    ...
                    List<IjsRateVO> rateVOList = 
                        excelUploadTemplate.getIjsBillingRateVOList();
                    ...
                    if(rateVOList!=null){
                        for (IjsRateVO rateVO: rateVOList) {
                            ...
                            try{
                            	 billRateResult = 
                                         rateSrv.getIjsContractRateDao().saveOrUpdateBillingRate(actionForm, 
                                                                                                 userInfo);	
                            }catch(NumberFormatException nfe){
                            	//failedContracts.add(contractVO.getContractId());
                                break;
                            ...
                            System.out.println("costRateResult --" + 
                                               billRateResult);
                            if (billRateResult != null && 
                                !billRateResult.contains("IJS_MSG")) {
                                continue;
                            }
    ...
    protected class GetIjsSearchStoredProcedure extends StoredProcedure {
        ...
        private static final String SQL_RLTD_CST_FOR_GST_SEARCH = 
            "PCR_IJS_CNTR_MAINTENANCE.PRR_IJS_CNTR_MAIN_SEARCH";

        GetIjsSearchStoredProcedure(JdbcTemplate jdbcTemplate, 
                                    RowMapper rowMapper) {
            super(jdbcTemplate, SQL_RLTD_CST_FOR_GST_SEARCH);
            declareParameter(new SqlOutParameter("p_o_v_ijs_mapping_list", 
                                                 OracleTypes.CURSOR, 
                                                 rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_trans_mod", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_start_date", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_end_date", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_find_in", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_find_val", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_vend_cd", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_frm_loc_typ", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_frm_loc", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_frm_trm", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_to_loc_typ", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_to_loc", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_to_trm", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_cnt_rout", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_country_code", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_user_id", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_priority", 
                                                   Types.VARCHAR, rowMapper)); //ROOMY
            declareParameter(new SqlInOutParameter("p_i_v_status", 
                                                   Types.VARCHAR, rowMapper)); //ROOMY
            declareParameter(new SqlInOutParameter("p_i_v_pur_term", 
            									   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_filter_by", 
					   							   Types.VARCHAR, rowMapper));
            declareParameter(new SqlOutParameter("p_io_v_err_cd", 
                                                 Types.VARCHAR, rowMapper));
        ...
        public List<IjsContractSearchDTO> getIjsContractSearchList(String transMode, 
                                                                   String dateRange, 
                                                                   String userId, 
                                                                   IjsContractSearchParamVO searchParam) {
            ...
            inParameters.put("p_i_v_trans_mod", 
                             RutDatabase.stringToDb(IjsHelper.getTransCode(transMode)));
            inParameters.put("p_i_v_start_date", 
                             RutDatabase.stringToDb(IjsHelper.getDateFromRange(dateRange, 
                                                                               "START_DATE")).toUpperCase());
            inParameters.put("p_i_v_end_date", 
                             RutDatabase.stringToDb(IjsHelper.getDateFromRange(dateRange, 
                                                                               "END_DATE")).toUpperCase());
            inParameters.put("p_i_v_find_in", 
                             RutDatabase.stringToDb(searchParam.getFindIn()).toUpperCase());
            inParameters.put("p_i_v_find_val", 
                             RutDatabase.stringToDb(searchParam.getFindValue()).toUpperCase());
            inParameters.put("p_i_v_vend_cd", 
                             RutDatabase.stringToDb(searchParam.getVendorCode()).toUpperCase());
            inParameters.put("p_i_v_frm_loc_typ", 
                             RutDatabase.stringToDb(IjsHelper.getLocationCode(searchParam.getFromLocType())));
            inParameters.put("p_i_v_frm_loc", 
                             RutDatabase.stringToDb(searchParam.getFromLocation()).toUpperCase());
            inParameters.put("p_i_v_frm_trm", 
                             RutDatabase.stringToDb(searchParam.getFromTerminal()).toUpperCase());
            inParameters.put("p_i_v_to_loc_typ", 
                             RutDatabase.stringToDb(IjsHelper.getLocationCode(searchParam.getToLocType())));
            inParameters.put("p_i_v_to_loc", 
                             RutDatabase.stringToDb(searchParam.getToLocation()).toUpperCase());
            inParameters.put("p_i_v_to_trm", 
                             RutDatabase.stringToDb(searchParam.getToTerminal()).toUpperCase());
            inParameters.put("p_i_v_cnt_rout", 
                             RutDatabase.stringToDb(searchParam.getContractNumber()).toUpperCase()); //roomy
            inParameters.put("p_i_v_country_code", 
                             RutDatabase.stringToDb(searchParam.getCountryCode()).toUpperCase());
            inParameters.put("p_i_v_user_id", 
                             RutDatabase.stringToDb(userId).toUpperCase());
            // roomy start
            inParameters.put("p_i_v_priority", 
                             RutDatabase.stringToDb(searchParam.getPriority()).toUpperCase());
    ...
    private class IjsContractSearchRowMapper implements RowMapper {
        ...
        public Object mapRow(ResultSet resultSet, int row) {
            IjsContractSearchDTO ijsContractSearchDto = 
                new IjsContractSearchDTO();
            ...
            try {
                ...
                ijsContractSearchDto.setExempted("Y".equals(resultSet.getString("EXEMPTED")) ? 
                                                 true : false);
                ...
                ijsContractSearchDto.setTerm(IjsHelper.convertStringToList(resultSet.getString("TERM")));//MD
    ...
    protected class IjsContractSaveStoredProcedure extends StoredProcedure {
        ...
        IjsContractSaveStoredProcedure(JdbcTemplate jdbcTemplate) {
            ...
            declareParameter(new SqlInOutParameter("p_i_v_action_type", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_vendor", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_start_date", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_end_date", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_transport_mode", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_status", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_payment_fsc", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_currency", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_priority", 
                                                   Types.NUMERIC));
            declareParameter(new SqlInOutParameter("p_i_v_from_loc_type", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_from_location", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_from_terminal", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_to_loc_type", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_to_location", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_to_terminal", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_hours", 
                                                   Types.NUMERIC));
            declareParameter(new SqlInOutParameter("p_i_v_days", 
                                                   Types.NUMERIC));
            declareParameter(new SqlInOutParameter("p_i_v_distance", 
                                                   Types.NUMERIC));
            declareParameter(new SqlInOutParameter("p_i_v_uom", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_remarks", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_exempted", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_contract_no", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_user_id", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_term_code", 
                                                   Types.VARCHAR));
            declareParameter(new SqlOutParameter("p_o_v_routing_id",
                                                   Types.VARCHAR));
            declareParameter(new SqlOutParameter("p_o_v_contract_id",
                                                   Types.VARCHAR));                                                   
            
            declareParameter(new SqlOutParameter("p_o_v_err_cd", 
                                                   Types.VARCHAR));
            compile();

        }

        private Map saveORUpdateContracts(IjsContractVO ijsContractVO, IjsLocationVO ijsLocationVO,
            ...
            inParameters.put("p_i_v_vendor", 
                             RutDatabase.stringToDb(ijsContractVO.getVendorCode()).toUpperCase());
            inParameters.put("p_i_v_start_date", 
            ...
            inParameters.put("p_i_v_payment_fsc", 
                             RutDatabase.stringToDb(ijsLocationVO.getPaymentFsc()).toUpperCase());
            inParameters.put("p_i_v_currency", 
                             RutDatabase.stringToDb(ijsLocationVO.getCurrency()).toUpperCase());
            ...
            inParameters.put("p_i_v_to_location", 
                             RutDatabase.stringToDb(ijsLocationVO.getToLocation()).toUpperCase());
            inParameters.put("p_i_v_to_terminal", 
                             RutDatabase.stringToDb(ijsLocationVO.getToTerminal()).toUpperCase());
            ...
            inParameters.put("p_i_v_uom", 
                             RutDatabase.stringToDb(ijsContractVO.getUom()).toUpperCase());
            inParameters.put("p_i_v_remarks", 
                             RutDatabase.stringToDb(ijsContractVO.getRemarks()).toUpperCase());
            inParameters.put("p_i_v_exempted", 
                             RutDatabase.stringToDb(ijsContractVO.isExempted() ? 
                                                    "Y" : "N"));
            inParameters.put("p_i_v_contract_no", 
                             RutDatabase.stringToDb(ijsContractVO.getContractId()).toUpperCase());
            inParameters.put("p_i_v_user_id", 
                             RutDatabase.stringToDb(userInfo).toUpperCase());
            ...
            } else if(ijsContractVO.getTerm().size()>0){
                inParameters.put("p_i_v_term_code" , RutDatabase.stringToDb(IjsHelper.convertListToString(ijsContractVO.getTerm())).toUpperCase()); 
            } else{
        ...
        private Map saveORUpdateContract(IjsContractVO ijsContractVO, 
                                         String userInfo, String action) {
            Map outMap ;
            Map inParameters = new HashMap();
            inParameters.put("p_i_v_action_type", 
            ...
            inParameters.put("p_i_v_status", 
                             RutDatabase.stringToDb(IjsHelper.getContractStatusCode(ijsContractVO.getStatus())).toUpperCase());
            inParameters.put("p_i_v_payment_fsc", 
                             RutDatabase.stringToDb(ijsContractVO.getPaymentFsc()).toUpperCase());
            inParameters.put("p_i_v_currency", 
                             RutDatabase.stringToDb(ijsContractVO.getCurrency()).toUpperCase());
            ...
            inParameters.put("p_i_v_to_location", 
                             RutDatabase.stringToDb(ijsContractVO.getToLocation()).toUpperCase());
            inParameters.put("p_i_v_to_terminal", 
                             RutDatabase.stringToDb(ijsContractVO.getToTerminal()).toUpperCase());
            inParameters.put("p_i_v_hours", ijsContractVO.getHours());
            inParameters.put("p_i_v_days", ijsContractVO.getDays());
            inParameters.put("p_i_v_distance", ijsContractVO.getDistance());
            inParameters.put("p_i_v_uom", 
    ...
    //##04 BEGIN
     ...
     protected class IjsContractPriorityValidationProcedure extends StoredProcedure {
         ...
         private Map validateContractPriorty(IjsContractVO ijsContractVO, IjsLocationVO ijsLocationVO) {
             ...
             Map inParameters = new HashMap();
             inParameters.put("p_i_v_priority", ijsLocationVO.getPriority());
             inParameters.put("p_i_v_from_location", RutDatabase.stringToDb(ijsLocationVO.getFromLocation()).toUpperCase());
             inParameters.put("p_i_v_from_terminal", RutDatabase.stringToDb(ijsLocationVO.getFromTerminal()).toUpperCase());                 
    ...
    protected class IjsContractDeleteStoredProcedure extends StoredProcedure {
        ...
        private String deleteContract(String contractId, String userInfo) {
            ...
            Map inParameters = new HashMap();
            inParameters.put("p_i_v_contract_no", 
                             RutDatabase.stringToDb(contractId).toUpperCase());
            inParameters.put("p_i_v_user_id", 
                             RutDatabase.stringToDb(userInfo).toUpperCase());
            outMap = execute(inParameters);
    ...
    protected class IjsContractCompareStoredProcedure extends StoredProcedure {
        ...
        private List<IjsContractSearchDTO> getContractList(IjsContractVO ijsContractVO, 
                                                           String userInfo) {
            Map outMap = new HashMap();
            Map inParameters = new HashMap();
            inParameters.put("p_i_v_start_date", 
    ...
    protected class IjsContractHistoryStoredProcedure extends StoredProcedure {
        private static final String SQL_RLTD_STR_FOR_HISTORY = 
            "PCR_IJS_CNTR_MAINTENANCE.PRR_IJS_CNTR_HISTORY";

        IjsContractHistoryStoredProcedure(JdbcTemplate jdbcTemplate, 
                                          RowMapper rowMapper) {
            super(jdbcTemplate, SQL_RLTD_STR_FOR_HISTORY);
            declareParameter(new SqlInOutParameter("p_i_v_contract_id", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_user_id", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlOutParameter("p_o_v_err_cd", Types.VARCHAR, 
                                                 rowMapper));
            declareParameter(new SqlOutParameter("p_o_v_ijs_cntr_hsty__list", 
                                                 OracleTypes.CURSOR, 
                                                 rowMapper));
            compile();
        }

        private List<IjsContractHistory> getHistoryList(String contractId, 
                                                        String userInfo) {
            Map outMap = new HashMap();
            Map inParameters = new HashMap();
            inParameters.put("p_i_v_contract_id", 
                             RutDatabase.stringToDb(contractId).toUpperCase());
            inParameters.put("p_i_v_user_id", 
                             RutDatabase.stringToDb(userInfo).toUpperCase());
            outMap = execute(inParameters);
    ...
    private class IjsContractHistoryRowMapper implements RowMapper {
        public IjsContractHistory mapRow(ResultSet resultSet, 
    ...
    protected class IjsContractGPPStoredProcedure extends StoredProcedure {
        private static final String SQL_GPP = 
            "PCR_IJS_CNTR_MAINTENANCE.CNTR_GEN_PORT_PAIR";
    ...
    protected class IjsCntrVendorDetailsStrdProce extends StoredProcedure {
        ...
        IjsCntrVendorDetailsStrdProce(JdbcTemplate jdbcTemplate, 
            ...
            declareParameter(new SqlInOutParameter("p_i_v_vendor_code", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlInOutParameter("p_i_v_user_id", 
                                                   Types.VARCHAR, rowMapper));
            declareParameter(new SqlOutParameter("p_o_v_err_cd", Types.VARCHAR, 
                                                 rowMapper));
            declareParameter(new SqlOutParameter("p_o_v_ijs_vndr_details_list", 
                                                 OracleTypes.CURSOR, 
                                                 rowMapper));
            compile();
        }
        ...
        private List<IjsVendorDetails> getVendorDetailsList(String vendorCode, 
            ...
            Map outMap = new HashMap();
            Map inParameters = new HashMap();
            inParameters.put("p_i_v_vendor_code", 
                             RutDatabase.stringToDb(vendorCode).toUpperCase());
            inParameters.put("p_i_v_user_id", 
                             RutDatabase.stringToDb(userInfo).toUpperCase());
            outMap = execute(inParameters);
    ...
    protected class GetIjsContractDownloadStoredProcedure extends StoredProcedure {
        /** Stored Procedure name */
        private static final String SQL_IJS_CNTR_MAIN_DOWNLOAD = 
            "PCR_IJS_CNTR_MAINTENANCE.PRR_IJS_CNTR_MAIN_DOWNLOAD";

        GetIjsContractDownloadStoredProcedure(JdbcTemplate jdbcTemplate, 
                                              RowMapper rowMapperForCostRate, 
                                              RowMapper rowMapperForBillRate) {
            super(jdbcTemplate, SQL_IJS_CNTR_MAIN_DOWNLOAD);
            declareParameter(new SqlOutParameter("p_o_v_ijs_cost_contract_list", OracleTypes.CURSOR,  rowMapperForCostRate));
            declareParameter(new SqlOutParameter("p_o_v_ijs_bill_contract_list", OracleTypes.CURSOR,  rowMapperForBillRate));
        ...
        public Map getIjsContractDownloadList(String transMode, 
                                              String dateRange, String userId, 
                                              IjsContractSearchParamVO searchParam, 
                                              List<IjsContractDownloadDTO> costRateResult, 
                                              List<IjsContractDownloadDTO> billRateResult, 
                                              String sessionId) {
            Map outMap = new HashMap();
            Map inParameters = new HashMap();

            inParameters.put("p_i_v_trans_mod", RutDatabase.stringToDb(IjsHelper.getTransCode(transMode)));
            inParameters.put("p_i_v_start_date",RutDatabase.stringToDb(IjsHelper.getDateFromRange(dateRange, "START_DATE")).toUpperCase());
            inParameters.put("p_i_v_end_date", RutDatabase.stringToDb(IjsHelper.getDateFromRange(dateRange, "END_DATE")).toUpperCase());
            ...
            inParameters.put("p_i_v_frm_loc_typ", RutDatabase.stringToDb(IjsHelper.getLocationCode(searchParam.getFromLocType())));
            ...
            inParameters.put("p_i_v_to_loc_typ", RutDatabase.stringToDb(IjsHelper.getLocationCode(searchParam.getToLocType())));
    ...
    private class IjsCostContractDownloadRowMapper implements RowMapper {
        ...
        public Object mapRow(ResultSet resultSet, int row) {
            IjsContractDownloadDTO ijsContractDownloadDto = 
                new IjsContractDownloadDTO();
            try {
    ...
    protected class GetIjstermListStoredProcedure extends StoredProcedure {
        private static final String SQL_RLTD_IJS_TERM = 
            "PCR_IJS_CNTR_MAINTENANCE.PRR_IJS_CNTR_TERM_SEARCH";

        GetIjstermListStoredProcedure(JdbcTemplate jdbcTemplate, 
                                      RowMapper rowMapper) {
    ...
    protected class GetIjsTransportModeListStoredProcedure extends StoredProcedure {
        private static final String SQL_RLTD_IJS_PAYMENT_METHOD = 
            "PCR_IJS_CNTR_MAINTENANCE.PRR_IJS_CNTR_TRANSPORT_MODE";

        GetIjsTransportModeListStoredProcedure(JdbcTemplate jdbcTemplate, 
                                      RowMapper rowMapper) {
            super(jdbcTemplate, SQL_RLTD_IJS_PAYMENT_METHOD);
            declareParameter(new SqlInOutParameter("p_i_v_user_id", 
                                                   Types.VARCHAR));
            declareParameter(new SqlInOutParameter("p_i_v_vendor_cd", 
                                                   Types.VARCHAR));
            declareParameter(new SqlOutParameter("p_o_v_err_cd", 
                                                 Types.VARCHAR));
            declareParameter(new SqlOutParameter("p_o_v_ijs_term_list", 
        ...
        private List<IjsContractTransportModeVO> getTransportMode(String userInfo, String vendorCode) {
            ...
            inParameters.put("p_i_v_user_id", 
                             RutDatabase.stringToDb(userInfo).toUpperCase());
            inParameters.put("p_i_v_vendor_cd", 
                             RutDatabase.stringToDb(vendorCode).toUpperCase());
            outMap = execute(inParameters);
...
//                transportMode.setCode(resultSet.getString("TERM_CODE"));
    ...
    protected class IjsCntrCurrencyForContractProcedure extends StoredProcedure {
        ...
        IjsCntrCurrencyForContractProcedure(JdbcTemplate jdbcTemplate, RowMapper rowMapper) {
            ...
            declareParameter(new SqlOutParameter("p_o_v_err_cd", Types.VARCHAR, rowMapper));
            declareParameter(new SqlOutParameter("p_o_v_ijs_currency_list", OracleTypes.CURSOR, 
                                                 rowMapper));
            compile();
            }
    ...
    protected class IjsCntrCurrencyForLocationProcedure extends StoredProcedure {
        ...
        IjsCntrCurrencyForLocationProcedure(JdbcTemplate jdbcTemplate) {
            ...
            inParameters.put("p_i_v_location_type", RutDatabase.stringToDb(IjsHelper.getLocationCode(locationType)).toUpperCase());
	...
	@Override
	public String doGenPortPair(String userId)
			throws IJSException {
		 return gppStoredProc.doGenPortPair(userId);
	}

	@Override
	public String validateFromToLocSetup(String fromLocation,
			String fromLocType, String toLocation, String toLocType,
			String transMode) throws IJSException {
		    String msgCode=ijsvalidateLocSetupProcedure.validateLocationSetup(fromLocType, fromLocation, toLocType, toLocation, transMode);
		    ...
		    return null;
		//return ijsvalidateLocSetupProcedure.validateLocationSetup(fromLocType, fromLocation, toLocType, toLocation, transMode);
	}
	 ...
	 protected class IjsCntrValidateLocationSetupProcedure extends StoredProcedure {
	        ...
	        IjsCntrValidateLocationSetupProcedure(JdbcTemplate jdbcTemplate) {
	            ...
	            private String validateLocationSetup(String fromLocType, String fromLocation, String toLocType, String toLocation,String transMode) {
	            Map outMap = new HashMap();
	            Map inParameters = new HashMap();
	            inParameters.put("p_i_v_from_loc", RutDatabase.stringToDb(fromLocation).toUpperCase());
	            inParameters.put("p_i_v_to_loc_type", RutDatabase.stringToDb(IjsHelper.getLocationCode(toLocType)).toUpperCase());
	            inParameters.put("p_i_v_to_loc",RutDatabase.stringToDb(toLocation).toUpperCase());
	            inParameters.put("p_i_v_trans_mode", RutDatabase.stringToDb(IjsHelper.getTransCode(transMode)).toUpperCase());
	            inParameters.put("p_i_v_user_id", "");
	            outMap = execute(inParameters);
	            return (String)outMap.get("p_o_v_error_cd");
