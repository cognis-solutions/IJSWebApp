...
03 07/08/15 BUN                       Added function Get week  in year from date time 
-----------------------------------------------------------------------------------------------------------*/
...
public class RutDate {
    ...
    */
    ...
    public static String toDateFormatFromYYYYMMDD(String date) {
        ...
        // 20011201 --> 01/12/2001
        if ((date != null) && (date != "") && (date.length() == 8)) {
            aDate = date.substring(6, 8) + "/" + date.substring(4, 6) +   "/" + String.valueOf(Integer.parseInt(date.substring(0, 4)));
            return aDate;
        } else
            return null;
    }
    ...
    /**
     * @param dateStr
     * @return - week in year  20151221 -->>  52 
     *         - week in year  20151231 -->>  1
     */
    public static String getWeekEndFromYear(String dateStr) {
        try {            
    ...
    /**
     * @param weekYear
     * @return - get From date to  week  52 -->> 21/12/2015 -- 27/12/2015   
     */
    public static String getFromDateToWeek(String dateStr) {
        try {            
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            Calendar cal = Calendar.getInstance();
    ...
    /**
     * @param weekYear
     * @return - get End date to  week  53 -->> 28/12/2015 -- 03/01/2016 
     */
    public static String getEndDateToWeek(int week) {
        try {            
            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            Calendar cal = Calendar.getInstance();
