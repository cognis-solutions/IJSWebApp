...
@Component({
  ...
  templateUrl: './rcl-fsc-look-up.component.html',
  styleUrls: ['./rcl-fsc-look-up.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: RclFSCLookUpComponent,
      multi: true
    }    
  ],
  encapsulation: ViewEncapsulation.Emulated
})
export class RclFSCLookUpComponent {
  ...
  @Output() currencyList = new EventEmitter();
  ...
  pc:number = 1;
  vendorSortData = [{label: 'FSC Code',value: 'FSCCode',}, {label: 'Description', value: 'Description'}, {label: 'Company Name', value: 'CompanyName'}, {label: 'City', value: 'City'}, {label: 'State', value: 'State'}, {label: 'Country', value: 'Country'}, {label: 'Status', value: 'Status'}]
...
//Dropdown select value
  ...
  openLookUpModal (e, popupContant){  
    $('#fsc-lookup-modal-center').detach();   
