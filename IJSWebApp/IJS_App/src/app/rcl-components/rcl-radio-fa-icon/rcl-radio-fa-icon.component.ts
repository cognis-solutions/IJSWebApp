...
@Component({
  ...
  templateUrl: './rcl-radio-fa-icon.component.html',
  styleUrls: ['./rcl-radio-fa-icon.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: RclRadioFaIconComponent,
      multi: true
    }
  ]
})
export class RclRadioFaIconComponent extends ElementBase<string> {
