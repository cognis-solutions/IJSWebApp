...
@Component({
    selector: 'app-rcl-ag-date',
    templateUrl: './rcl-ag-date.component.html',
    styleUrls: ['./rcl-ag-date.component.scss']
})
export class RclAgDateComponent implements IDateAngularComp {
    private date: Date;
