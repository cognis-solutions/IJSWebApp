...
public class IjsMaintainJOSearchContDetailVO {
	...
	public String getSpHandling() {
		return spHandling;
	}

	public void setSpHandling(String spHandling) {
		this.spHandling = spHandling;
	}
