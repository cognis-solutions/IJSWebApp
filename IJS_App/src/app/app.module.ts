...
@NgModule({
  ...
  providers: [RclComponentsModule, DatePipe, SpinnerServiceService, ServerErrorcodeService, LookUpdataServiceService, UserService, WindowRefService, FileUploadService, RclappUrlService, DownloadFileService, UserTypeService,SpecialHandlingService,PortClassService,ImdgClassService,SessionTimeOutService,ContainerListService, 
  {
