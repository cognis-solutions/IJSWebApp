...
@Component({
  selector: 'app-processjo-search-filter',
  templateUrl: './processjo-search-filter.component.html',
  styleUrls: ['./processjo-search-filter.component.scss']
})
export class ProcessjoSearchFilterComponent implements OnInit {
