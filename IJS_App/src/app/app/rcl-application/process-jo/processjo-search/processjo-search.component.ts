...
export class ProcessjoSearchComponent implements OnInit {
  //chandu
  e: any;
  adHocFalg: boolean = false;
  blDisableFlage: boolean= false;
  //end
  ...
  //chandu
  private processjoAdHoc = [{ id: "Empty Repo", text: "Empty" }, { id: "laden ad-hoc", text: "Laden" }]
  ...
  //chandu
  @ViewChild('proceessJoAdHocTip') proceessJoAdHocTip;
  ...
  private callingComponent = "adHocType"
...
this.blDisableFlage = true;
  ...
  //chandu:start
  private changeAdHocTypeValue(e){
...
//nikash
  private searchProcessJoOrderMain(e)
  {
  ...
  private searchProcessJoOrder(e) {
...
//debugger;
 ...
 if(this.processJoSearchData.processJoParam.fromLocType=="Port" ){
    if(this.processJoSearchData.processJoParam.toLocType=="Port"){
    if(this.processJoSearchData.processJoParam.fromTerminal !=undefined && this.processJoSearchData.processJoParam.toTerminal !=undefined &&
      this.processJoSearchData.processJoParam.fromTerminal!="" && this.processJoSearchData.processJoParam.toTerminal !=""){
     this.getEquipmentsLimit(); 
     }else {
        this.validationTextFlag = true;
    this.validationText = "Please provide all required fields."
    this.e.target.checked = false;
     }
    }else if(this.processJoSearchData.processJoParam.toLocType=="Door"){
     if(this.processJoSearchData.processJoParam.fromTerminal !=undefined && this.processJoSearchData.processJoParam.toLocation != undefined
      && this.processJoSearchData.processJoParam.fromTerminal !=""&& this.processJoSearchData.processJoParam.toLocation != ""){
      this.getEquipmentsLimit(); 
     }else {
      this.validationTextFlag = true;
      this.validationText = "Please provide all required fields."
    ...
    }else if(this.processJoSearchData.processJoParam.toLocType=="Terminal"){
       if(this.processJoSearchData.processJoParam.toLocation != undefined
     && this.processJoSearchData.processJoParam.fromTerminal !=undefined && this.processJoSearchData.processJoParam.toTerminal !=undefined
   &&this.processJoSearchData.processJoParam.toLocation != ""
     && this.processJoSearchData.processJoParam.fromTerminal !="" && this.processJoSearchData.processJoParam.toTerminal !=""){
      this.getEquipmentsLimit(); 
    } else {
      this.validationTextFlag = true;
    ...
    else if(this.processJoSearchData.processJoParam.toLocType=="Depot"){
      if(this.processJoSearchData.processJoParam.toLocation != undefined
        && this.processJoSearchData.processJoParam.fromTerminal !=undefined && this.processJoSearchData.processJoParam.toTerminal !=undefined
      && this.processJoSearchData.processJoParam.toLocation != ""
        && this.processJoSearchData.processJoParam.fromTerminal !="" && this.processJoSearchData.processJoParam.toTerminal !=""){
  ...
  else if(this.processJoSearchData.processJoParam.toLocType=="Haulage"){
    if(this.processJoSearchData.processJoParam.toLocation != undefined
      && this.processJoSearchData.processJoParam.fromTerminal !=undefined && this.processJoSearchData.processJoParam.toTerminal !=undefined
    && this.processJoSearchData.processJoParam.toLocation != ""
      && this.processJoSearchData.processJoParam.fromTerminal !="" && this.processJoSearchData.processJoParam.toTerminal !=""){
  ...
  else if(this.processJoSearchData.processJoParam.fromLocType=="Door" )
  {
 
   if(this.processJoSearchData.processJoParam.toLocType=="Port"){
     if(this.processJoSearchData.processJoParam.fromLocation!=undefined && this.processJoSearchData.processJoParam.toTerminal !=undefined
      && this.processJoSearchData.processJoParam.fromLocation!="" && this.processJoSearchData.processJoParam.toTerminal !=""){
     this.getEquipmentsLimit(); 
     }else {
      this.validationTextFlag = true;
      this.validationText = "Please provide all required fields."
     ...
     if(this.processJoSearchData.processJoParam.fromLocation !=undefined && this.processJoSearchData.processJoParam.toLocation != undefined){
      this.getEquipmentsLimit(); 
     }else {
      this.validationTextFlag = true;
      this.validationText = "Please provide all required fields."
      this.e.target.checked = false;
       ...
       if(this.processJoSearchData.processJoParam.fromLocation != undefined && this.processJoSearchData.processJoParam.toLocation != undefined
   && this.processJoSearchData.processJoParam.toTerminal !=undefined 
   && this.processJoSearchData.processJoParam.fromLocation != "" && this.processJoSearchData.processJoParam.toLocation != ""
   && this.processJoSearchData.processJoParam.toTerminal !=""){
      this.getEquipmentsLimit(); 
    }else {
      this.validationTextFlag = true;
      this.validationText = "Please provide all required fields."
  ...
  else if(this.processJoSearchData.processJoParam.fromLocType=="Terminal" )
  {
   ...
   if(this.processJoSearchData.processJoParam.toLocType=="Port"){
     if(this.processJoSearchData.processJoParam.fromLocation !=undefined && this.processJoSearchData.processJoParam.toTerminal !=undefined
      && this.processJoSearchData.processJoParam.fromTerminal !=undefined
      && this.processJoSearchData.processJoParam.fromLocation !="" && this.processJoSearchData.processJoParam.toTerminal !=""
      && this.processJoSearchData.processJoParam.fromTerminal !=""){
     this.getEquipmentsLimit(); 
     }else{
      this.validationTextFlag = true;
      this.validationText = "Please provide all required fields."
  ...
  else if(this.processJoSearchData.processJoParam.fromLocType=="Depot")
  {
  ...
  }else if(this.processJoSearchData.processJoParam.fromLocType=="Haulage" )
  {
