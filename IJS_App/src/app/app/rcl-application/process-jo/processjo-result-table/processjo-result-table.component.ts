...
export class ProcessjoResultTableComponent implements OnInit {
  ...
  showRouteListModalForMultiVendor(e,row,joType,singleloc,callingComponent)
  {
    this._prosessjoRouteListBLBooking.openLookUpModalMultiVendor(row,joType,singleloc,callingComponent);
  ...
  showCostCalcForMultiVendor(e)
  {
    //debugger;


    this.joType = this.processJoSearchData.processJoParam.processJoType;
    //this.transportType = this.processJoSearchData.processJoParam.transMode;
   
    this.singleloc = "multiple"; 
    this.callingComponent = "processJoMultiple";
   // this.openModal=true;
    this.showRouteListModalForMultiVendor(e, this.checkedSelectedRows,this.joType,this.singleloc,this.callingComponent);
  }
  ...
  showJoSummery(e) {
    ...
    if (this.chnageVendorSelectedRow != undefined) {
      ...
      if (this.chnageVendorSelectedRow.saveClicked) {
       ...
       // this.showCostCalcForMultiVendor(e) 
