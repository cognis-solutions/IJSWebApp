...
@Component({
  selector: 'app-jo-container-upload',
  templateUrl: './jo-container-upload.component.html',
  styleUrls: ['./jo-container-upload.component.scss']
})
export class JoContainerUploadComponent implements OnInit {
    ...
    saveUploadedFile(e){ 
      this.prepairRautingId(this._processjoSearchService.vendorDetails)

      this._processjoSearchService.processJoSearchData.processJoParam['processJoType']
      let addhoc ;
      // if(this.addHocType == 'Empty Repo')
      if(this._processjoSearchService.processJoSearchData.processJoParam['processJoType']=="ER")
        {
          addhoc = 'E'
        } else if (this._processjoSearchService.processJoSearchData.processJoParam['processJoType']=="LAH") {
          addhoc = 'L'
        }
        //addhoc = 'L';  
      ...
      let saveobj = {
        uploadVO: {
          ...
          'contractsID' :this.allRoutingIds
        }      
      }
