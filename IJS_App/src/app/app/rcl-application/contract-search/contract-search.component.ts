...
export class ContractSearchComponent implements OnInit {
  ...
  filterData: any = [
    ...
    { name: "Sort in", type: "radio", data: [{ id: "vendorCode", text: "Vendor id" }, { id: "vendorName", text: "Vendor name" }, { id: "contractId", text: "Contract id" }, { id: "startDate", text: "Start date" }, { id: "priority", text: "Priority" }, { id: "MT", text: "Empty" }, { id: "LADEN", text: "Laden" }] },
  ...
  showEditContract(rowObj, e) {
    ...
    if(rowObj['domInn']==undefined||rowObj['domInn']==""){
       if(rowObj['fromLocation']==rowObj["toLocation"]){
        rowObj['domInn']='Domestic';
       }else if(rowObj['fromLocation']!=rowObj["toLocation"]){
        rowObj['domInn']='International';
       }
      }else{
      rowObj['domInn'];
    }
  ...
  formValidationSimpleSearch() {
    ...
    let domInn  = this.simpleContSearchData.contractParam.searchScreenParam.domInn;
    //console.log(this.filterDataSelectedComp.sortIn);
  
    if("MT" === this.filterDataSelectedComp.sortIn) {
      this.simpleContSearchData.contractParam.searchScreenParam.sortIn = this.filterData[0].data[5].id
    }
    else if("LADEN" === this.filterDataSelectedComp.sortIn) {
      this.simpleContSearchData.contractParam.searchScreenParam.sortIn = this.filterData[0].data[6].id;
    }
    else {
      this.simpleContSearchData.contractParam.searchScreenParam.sortIn = null;
    }

    if("lp"===this.filterDataSelectedComp.orderBy)
    {
      this.simpleContSearchData.contractParam.searchScreenParam.orderBy='lp';
    }else if("hp"===this.filterDataSelectedComp.orderBy)
    {
      this.simpleContSearchData.contractParam.searchScreenParam.orderBy='hp';
    }
 ...
 // prioritysorting:[];
  ...
  addRemoveSortFilter(filterDataSelectedComp, tableDataContractSearch1) {
    ...
    var tableDataContractSearchForLocationArray=[];
    var tableDataContractSearchForLocationArrayMAIN=[];
   // var tableDataContractSearchForLocation={};
    //debugger;
 
    for(var i =0;i<this.tableDataContractSearch.length;i++) 
    {
       if(this.tableDataContractSearch[i].laden=="LADEN"){
        var count=0;
        if(tableDataContractSearchForLocationArrayMAIN.length==0){
         
          if(this.tableDataContractSearch[i].laden20!="")
                  {costTemp=this.tableDataContractSearch[i].laden20}
                  else if(this.tableDataContractSearch[i].laden40!="")
                  {costTemp=this.tableDataContractSearch[i].laden20}
          var tableDataContractSearchForLocation={
          'fromLocType':this.tableDataContractSearch[i].fromLocType,
          'toLocType':this.tableDataContractSearch[i].toLocType,
          'fromLocation': this.tableDataContractSearch[i].fromLocation,
          'toLocation':this.tableDataContractSearch[i].toLocation,
          'fromTerminal': this.tableDataContractSearch[i].fromTerminal,
          'toTerminal':this.tableDataContractSearch[i].toTerminal,
          'transMode':this.tableDataContractSearch[i].transMode,
          'tempcost':costTemp
          }
          tableDataContractSearchForLocationArray.push(tableDataContractSearchForLocation);
          tableDataContractSearchForLocationArrayMAIN.push(tableDataContractSearchForLocationArray);
        }else{
     // var breakFalg=false;   
      for(var j=0;j<tableDataContractSearchForLocationArrayMAIN.length;j++)
          {

            if(this.tableDataContractSearch[i].fromLocation==tableDataContractSearchForLocationArrayMAIN[j][0].fromLocation
              && this.tableDataContractSearch[i].toLocation==tableDataContractSearchForLocationArrayMAIN[j][0].toLocation
              && this.tableDataContractSearch[i].transMode == tableDataContractSearchForLocationArrayMAIN[j][0].transMode
              && this.tableDataContractSearch[i].fromTerminal == tableDataContractSearchForLocationArrayMAIN[j][0].fromTerminal
              && this.tableDataContractSearch[i].toTerminal == tableDataContractSearchForLocationArrayMAIN[j][0].toTerminal
                ){var costTempCount=0;
                  var tableDataContractSearchForLocationArray=[];
                  var costTemp="";
                  if(this.tableDataContractSearch[i].laden20!="")
                  ...
                  {costTemp=this.tableDataContractSearch[i].laden20}
                  for(var k=0;k<tableDataContractSearchForLocationArrayMAIN[j].length;k++)
                  {
                    if(costTemp==tableDataContractSearchForLocationArrayMAIN[j][k].tempcost)
                    {costTempCount++;}
                  }
                  if(costTempCount==0){
                    var tableDataContractSearchForLocation={
                    ...
                    tableDataContractSearchForLocationArrayMAIN[j].push(tableDataContractSearchForLocation);
                    //breakFalg=true;
                   }
                   count=0;
                   break;
        ...
        }else if(this.tableDataContractSearch[i].mT=="MT"){
          var count=0;
          if(tableDataContractSearchForLocationArrayMAIN.length==0){
           
            if(this.tableDataContractSearch[i].mt20!="")
                    {costTemp=this.tableDataContractSearch[i].mt20}
                    else if(this.tableDataContractSearch[i].mT40!="")
                    {costTemp=this.tableDataContractSearch[i].mT40}
            var tableDataContractSearchForLocation={
            'fromLocType':this.tableDataContractSearch[i].fromLocType,
            'toLocType':this.tableDataContractSearch[i].toLocType,
            'fromLocation': this.tableDataContractSearch[i].fromLocation,
       ...
       for(var i=0;i<tableDataContractSearchForLocationArrayMAIN.length;i++){
        tableDataContractSearchForLocationArrayMAIN[i].sort(function(a, b){return  a.tempcost - b.tempcost });
       }
       for(var i=0;i<tableDataContractSearchForLocationArrayMAIN.length;i++){
         for(var j=0;j<tableDataContractSearchForLocationArrayMAIN[i].length;j++){
          tableDataContractSearchForLocationArrayMAIN[i][j].tempPriority=j+1;
         }
       }
       ...
       for(var j=0;j<tableDataContractSearchForLocationArrayMAIN.length;j++)
       {
          ...
          && this.tableDataContractSearch[i].toTerminal == tableDataContractSearchForLocationArrayMAIN[j][0].toTerminal)
         {
           for(var k=0;k<tableDataContractSearchForLocationArrayMAIN[j].length;k++)
           {
             if(this.tableDataContractSearch[i].laden20!="")
             {
              if(this.tableDataContractSearch[i].laden20==tableDataContractSearchForLocationArrayMAIN[j][k].tempcost)
              {
                this.tableDataContractSearch[i].costPriority=tableDataContractSearchForLocationArrayMAIN[j][k].tempPriority;
              }
             }else if(this.tableDataContractSearch[i].laden40!="")
             {
              if(this.tableDataContractSearch[i].laden40==tableDataContractSearchForLocationArrayMAIN[j][k].tempcost)
              {
                this.tableDataContractSearch[i].costPriority=tableDataContractSearchForLocationArrayMAIN[j][k].tempPriority;
              }
             }
        ...
        for(var j=0;j<tableDataContractSearchForLocationArrayMAIN.length;j++)
        {
           ...
           )
          {
            for(var k=0;k<tableDataContractSearchForLocationArrayMAIN[j].length;k++)
            {
              if(this.tableDataContractSearch[i].mt20!="")
              {
               if(this.tableDataContractSearch[i].mt20==tableDataContractSearchForLocationArrayMAIN[j][k].tempcost)
               {
                 this.tableDataContractSearch[i].costPriority=tableDataContractSearchForLocationArrayMAIN[j][k].tempPriority;
               }
              }else if(this.tableDataContractSearch[i].mt40!="")
              {
               if(this.tableDataContractSearch[i].mt40==tableDataContractSearchForLocationArrayMAIN[j][k].tempcost)
               {
                 this.tableDataContractSearch[i].costPriority=tableDataContractSearchForLocationArrayMAIN[j][k].tempPriority;
               }
              }
    ...
    if("lp"===this.filterDataSelectedComp.orderBy)
    {
      this.tableDataContractSearch.sort(function(a, b){
        return b.costPriority - a.costPriority;
    });
    }else if("hp"===this.filterDataSelectedComp.orderBy)
    {
       this.tableDataContractSearch.sort(function(a, b){
          return a.costPriority - b.costPriority;
      });
...
tableDataContractSearchForLocations = [];
  ...
  getFilterCriteria(){
    ...
    if(this.filterDataSelectedComp.sortIn=="er"){
      this.filterDataSelectedComp.sortInText="Empty Rate";
    }
    if(this.filterDataSelectedComp.sortIn=="lr"){
      this.filterDataSelectedComp.sortInText="Laden Rate";
    }
