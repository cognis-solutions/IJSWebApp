...
export class ContractSearchService {
    ...
    validateDate(searchDataObj: any): Observable<any> 
    {
        let searchData; 
        searchData={
            contract: {
                'contractId':searchDataObj
           
          
        }
    }
        let contractForSave = JSON.stringify(searchData);
        return this._http.post( this._rclappUrlService.url + '/IJSWebApp/dateValidate.do',contractForSave)
