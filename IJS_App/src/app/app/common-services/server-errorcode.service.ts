...
export class ServerErrorcodeService {
  ...
  errorCodes = {
    ...
    "IJS_EX_10026": "Expiry Date is not allowed,due to Job order created after this date",
    "IJS_EX_100303030":"Expiry Date shouldn't be less then effective Date",
  ...
  "IJS_CNTR_EX_10031" : " Auto calculated max Priority(99) is already assigned.",
   "IJS_CNTR_EX_10034" : "Generate Port Pair is already done,this action can be performed again after",
    ...
    "COST RATE NOT FOURND": "Cost Rate not Found.",
    "IJS_EX_1000121":"Given expire Date is not allowed"
  }
