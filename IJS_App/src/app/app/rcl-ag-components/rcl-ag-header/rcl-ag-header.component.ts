...
@Component({
  selector: 'app-rcl-ag-header',
  templateUrl: './rcl-ag-header.component.html',
  styleUrls: ['./rcl-ag-header.component.scss']
})
export class RclAgHeaderComponent implements IHeaderAngularComp {
