...
@Component({
  ...
  templateUrl: './rcl-customer-lookup.component.html',
  styleUrls: ['./rcl-customer-lookup.component.scss']
})
export class RclCustomerLookupComponent {
  ...
  @Output() selectRowEmit = new EventEmitter();
  customerName:string;//#NIIT CR4
  @Output() customerNameEmit = new EventEmitter();//#NIIT CR4
...
private ngbmodalRef: NgbModalRef;
  ...
  custSortData = [{ label: 'Customer Code',value: 'custCode'}, {label: 'NameBill To Party',value: 'custName',}, {label: 'Finance Interface Customer Code', value: 'custCodeFI'}, {label: 'City', value: 'city'}, {label: 'Country', value: 'country'}, {label: 'Status', value: 'status'}]
...
//Dropdown select value
  ...
  openLookUpModal (e, popupContant){  
    $('#customer-lookup-modal-center').detach(); 
