...
@Component({
  ...
  templateUrl: './rcl-dg-imdg-com-look-up.component.html',
  styleUrls: ['./rcl-dg-imdg-com-look-up.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: RclDGIMDGLookUpComponent,
      multi: true
    }    
  ],
  encapsulation: ViewEncapsulation.Emulated
})
export class RclDGIMDGLookUpComponent {
...
//Dropdown select value
 ...
 // openLookUpModal (e, popupContant){  let routeBackEndData = this.getBackEndData();
  openLookUpModal (row){       
    ...
    this.seachValueList  =[];
    let obj = { "key": "bookType", "value": this.searchCriteria.processJoParam.bookingType};
